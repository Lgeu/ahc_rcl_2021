...
constexpr double K_START = 0.02238995345705376;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04615017260313044;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.6319290859288067;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 822;  // OPTIMIZE [780, 880]
