...
constexpr double K_START = 0.021003835186361796;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.0484447736977684;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.6020906623406183;      // OPTIMIZE [0.001, 0.999]
