...
constexpr double K_START = 0.02191746301634125;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.03928708502905512;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.5653206144013834;      // OPTIMIZE [0.001, 0.999]
