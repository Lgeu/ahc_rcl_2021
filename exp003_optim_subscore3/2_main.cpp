...
constexpr double K_START = 0.0204387820904594;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04788707123930524;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.4611712744787681;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 833;  // OPTIMIZE [780, 880]
