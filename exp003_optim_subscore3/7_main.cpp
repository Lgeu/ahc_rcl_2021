...
constexpr double K_START = 0.020298301153123127;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04990635952636971;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.7022139010048758;      // OPTIMIZE [0.001, 0.999]
