...
constexpr double K_START = 0.02142346077505086;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.03659939126357597;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.5829701816652807;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 816;  // OPTIMIZE [780, 880]
