...
constexpr double K_START = 0.04339342633394555;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04446193145681512;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.5195743483645378;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 825;  // OPTIMIZE [780, 880]
