...
constexpr double K_START = 0.02107233560622565;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04837330345359281;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.6068194837376637;      // OPTIMIZE [0.001, 0.999]
