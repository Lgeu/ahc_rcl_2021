...
constexpr double K_START = 0.02228374739475911;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04754833610728247;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.7830396513759729;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 820;  // OPTIMIZE [780, 880]
