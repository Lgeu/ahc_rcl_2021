...
constexpr double K_START = 0.02374431554918074;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.042972155804894836;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.5954143483764675;      // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 827;  // OPTIMIZE [780, 880]
