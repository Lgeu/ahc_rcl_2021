...
constexpr double K_START = 0.020391196745071095;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04844228632845984;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.595883325853743;      // OPTIMIZE [0.001, 0.999]
