...
constexpr double K_START = 0.04909745346197107;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.01636229668357072;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.6845928817682423;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 852;  // OPTIMIZE [780, 880]
