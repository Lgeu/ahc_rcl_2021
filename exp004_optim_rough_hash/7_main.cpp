...
constexpr double K_START = 0.041013268255389215;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.03856737025146465;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.9431868448216628;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 826;  // OPTIMIZE [780, 880]
