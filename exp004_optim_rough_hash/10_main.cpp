...
constexpr double K_START = 0.039586974043630214;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.022078880037355253;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.7584071270834815;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 831;  // OPTIMIZE [780, 880]
