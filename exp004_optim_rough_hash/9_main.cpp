...
constexpr double K_START = 0.03651478832094366;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.02970626114364123;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.8645516357901203;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 814;  // OPTIMIZE [780, 880]
