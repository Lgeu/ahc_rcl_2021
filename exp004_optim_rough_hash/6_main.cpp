...
constexpr double K_START = 0.044844320763263085;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.036877131180158805;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.8069328307034332;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 830;  // OPTIMIZE [780, 880]
