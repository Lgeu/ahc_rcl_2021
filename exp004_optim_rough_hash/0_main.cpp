...
constexpr double K_START = 0.031905482424130216;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.041425434604829454;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.3951072739585427;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 846;  // OPTIMIZE [780, 880]
