...
constexpr double K_START = 0.03793219086750834;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.040718040885689456;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.8073896059819027;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 837;  // OPTIMIZE [780, 880]
