...
constexpr double K_START = 0.040260060263822006;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.03761408199463084;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.8003018502942253;      // OPTIMIZE [0.001, 0.999]
