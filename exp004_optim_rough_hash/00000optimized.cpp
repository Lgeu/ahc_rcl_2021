...
constexpr double K_START = 0.020377386452152316;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.047040402734174265;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.7661694419128214;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 829;  // OPTIMIZE [780, 880]
