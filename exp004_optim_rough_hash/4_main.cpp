...
constexpr double K_START = 0.034189857729127;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04722196261500551;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.7281475302052164;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 842;  // OPTIMIZE [780, 880]
