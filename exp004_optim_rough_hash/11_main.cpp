...
constexpr double K_START = 0.028692321756125908;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.024780194734977508;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.482748080295636;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 823;  // OPTIMIZE [780, 880]
