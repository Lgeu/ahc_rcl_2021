...
constexpr double K_START = 0.03825057192254696;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04342547075112909;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.9046812150241018;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 836;  // OPTIMIZE [780, 880]
