...
constexpr double K_START = 0.05046190715058047;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.037058285231767844;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7362504203269352;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 857;  // OPTIMIZE [750, 900]
