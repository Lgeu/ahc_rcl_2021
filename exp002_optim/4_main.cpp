...
constexpr double K_START = 0.058828280346923036;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.03618944286610014;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7153467284981987;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 849;  // OPTIMIZE [750, 900]
