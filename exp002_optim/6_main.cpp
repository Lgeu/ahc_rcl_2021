...
constexpr double K_START = 0.05305699385115308;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.03149727288732441;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.6914254216550436;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 843;  // OPTIMIZE [750, 900]
