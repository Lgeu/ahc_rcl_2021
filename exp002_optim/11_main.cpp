...
constexpr double K_START = 0.09233083245710752;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.01511230495134349;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.8767136294450842;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 803;  // OPTIMIZE [750, 900]
