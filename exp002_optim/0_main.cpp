...
constexpr double K_START = 0.03466997660271959;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.02409034368519931;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.6610745148591279;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 811;  // OPTIMIZE [750, 900]
