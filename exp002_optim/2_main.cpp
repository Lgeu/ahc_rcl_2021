...
constexpr double K_START = 0.04615449118987759;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.03600687157897227;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7697579296613748;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 837;  // OPTIMIZE [750, 900]
