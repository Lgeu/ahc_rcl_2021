...
constexpr double K_START = 0.0382618608851512;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.019972103905918307;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7556281917154819;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 851;  // OPTIMIZE [750, 900]
