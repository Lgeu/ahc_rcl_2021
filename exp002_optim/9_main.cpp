...
constexpr double K_START = 0.04791443623149954;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.02941282732959385;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7967248171507444;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 792;  // OPTIMIZE [750, 900]
