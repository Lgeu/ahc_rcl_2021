...
constexpr double K_START = 0.056820300826639206;            // OPTIMIZE [0.02, 0.10] LOG
constexpr double K_END = 0.0363721028316352;              // OPTIMIZE [0.005, 0.04] LOG
constexpr double K_H = 0.7449768605759084;                 // OPTIMIZE [0.001, 0.999]

constexpr int hash_table_size = 19;
constexpr int beam_width = 200;

constexpr short PURCHASE_TURN_LIMIT = 846;  // OPTIMIZE [750, 900]
