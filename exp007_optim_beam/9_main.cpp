...
constexpr double K_START = 0.11120388862000831;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.0541603713322653;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6266051492037881;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.7138068005026054;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6661143348979347;  // OPTIMIZE [0.02, 0.98]
