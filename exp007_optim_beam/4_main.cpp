...
constexpr double K_START = 0.10655075166809017;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.050477830168623526;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6122469070024132;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8218582944277905;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.3351975779947175;  // OPTIMIZE [0.02, 0.98]
