...
constexpr double K_START = 0.11244934405394949;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.05484917101925988;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5695863685634603;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8233723325464233;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.2752142800496969;  // OPTIMIZE [0.02, 0.98]
