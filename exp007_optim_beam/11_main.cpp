...
constexpr double K_START = 0.10931212657978638;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.05453376993411145;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6127147548641197;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8719958252991629;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.33283587364438927;  // OPTIMIZE [0.02, 0.98]
