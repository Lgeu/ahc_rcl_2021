...
constexpr double K_START = 0.11333893656335717;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.05376956640247519;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5694223433633996;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.7165059780146827;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.38573455727683575;  // OPTIMIZE [0.02, 0.98]
