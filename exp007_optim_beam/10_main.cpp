...
constexpr double K_START = 0.1105837258251293;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.06060444180439478;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8324943176772278;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.5825389733364509;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4861304895052866;  // OPTIMIZE [0.02, 0.98]
