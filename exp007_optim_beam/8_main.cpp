...
constexpr double K_START = 0.11068711306617375;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.054358471433307555;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.837542397896033;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 832;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.5044999094427652;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6771721793300469;  // OPTIMIZE [0.02, 0.98]
