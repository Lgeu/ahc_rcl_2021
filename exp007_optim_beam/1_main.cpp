...
constexpr double K_START = 0.10836149050514345;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.05040067084802565;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6166455640619871;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.5879343647490073;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4937763627732547;  // OPTIMIZE [0.02, 0.98]
