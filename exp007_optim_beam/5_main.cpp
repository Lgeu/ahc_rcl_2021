...
constexpr double K_START = 0.10555994001247487;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.05158109980135089;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5455970765023039;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.6479463111946171;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4200920485882308;  // OPTIMIZE [0.02, 0.98]
