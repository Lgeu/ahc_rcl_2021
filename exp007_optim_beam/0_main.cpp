...
constexpr double K_START = 0.10755464565352929;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.060296207201359836;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6259342046499384;      // OPTIMIZE [0.001, 0.999]
...
constexpr int ROUGH_HASH = 0b00010011;      // OPTIMIZE {0, 0b00000001, 0b00010001, 0b00010011, 0b00110011}

// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.9373935889967022;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4299394590833288;  // OPTIMIZE [0.02, 0.98]
