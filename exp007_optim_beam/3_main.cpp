...
constexpr double K_START = 0.10686701195265046;  // OPTIMIZE [0.04, 0.12] LOG
constexpr double K_END = 0.050169646691184316;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6235148950134719;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.686465049437356;      // OPTIMIZE [0.5, 1.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.3309508621261795;  // OPTIMIZE [0.02, 0.98]
