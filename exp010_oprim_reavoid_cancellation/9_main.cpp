...
constexpr double K_START = 0.16470082988127216;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.04767952434931199;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7366364692019733;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 839;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.35695933480649;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.49990609889017434;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 680;                        // OPTIMIZE [400, 4000] LOG
