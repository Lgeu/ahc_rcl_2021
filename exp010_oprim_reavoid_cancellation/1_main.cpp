...
constexpr int hash_table_size = 8;         // OPTIMIZE [6, 18]


// K: 大きいほど未来の価値が小さくなる log2/100 = 0.007 くらいのとき野菜のインフレと釣り合う？
constexpr double K_START = 0.1550478931098103;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.048287219513904155;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7138138893268379;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 835;  // OPTIMIZE [790, 870]

// 0 で通常
constexpr int SUBSCORE3_TIGHT_TURN = 0;     // OPTIMIZEd

constexpr int ROUGH_HASH = 0b00000001;      // OPTIMIZE {0, 0b00000001, 0b00010001, 0b00010011, 0b00110011}

// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.0447362672642835;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.46891872295209375;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 526;                        // OPTIMIZE [400, 4000] LOG
