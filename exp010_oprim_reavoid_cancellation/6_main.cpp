...
constexpr double K_START = 0.16618720669253373;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051326175890926154;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7247979651124842;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.484540003857199;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4941524382040213;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 612;                        // OPTIMIZE [400, 4000] LOG
