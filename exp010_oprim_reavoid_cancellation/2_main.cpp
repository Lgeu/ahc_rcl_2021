...
constexpr double K_START = 0.16875925266488023;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05009343501334246;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.888570515513328;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 828;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1135705141809138;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.46870103199372165;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 528;                        // OPTIMIZE [400, 4000] LOG
