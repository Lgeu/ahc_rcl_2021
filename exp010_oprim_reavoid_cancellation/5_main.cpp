...
constexpr double K_START = 0.16829570793564028;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05145180320388739;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.798770701632966;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.514300365896753;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4948600279028328;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 611;                        // OPTIMIZE [400, 4000] LOG
