...
constexpr double K_START = 0.07210219658391823;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05073518583083631;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6622763514959873;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.803315627002894;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.44338622146506407;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 609;                        // OPTIMIZE [400, 4000] LOG
