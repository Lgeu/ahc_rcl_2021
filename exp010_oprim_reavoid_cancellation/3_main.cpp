...
constexpr double K_START = 0.18026609519856265;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05404272404075606;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8807689050190319;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.12921244481046;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.4134083636010235;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 544;                        // OPTIMIZE [400, 4000] LOG
