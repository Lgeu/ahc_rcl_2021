...
constexpr double K_START = 0.16937104475483808;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05091566655834445;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7357445488394715;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 836;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.3017004553455753;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.49599773509624767;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 697;                        // OPTIMIZE [400, 4000] LOG
