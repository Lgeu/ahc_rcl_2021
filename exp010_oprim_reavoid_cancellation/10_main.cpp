...
constexpr double K_START = 0.10463537718897797;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05316877218201365;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.804535346679094;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 817;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.289484843025879;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5479113697757838;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 691;                        // OPTIMIZE [400, 4000] LOG
