...
constexpr double K_START = 0.165299398030028;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.0884836162585196;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7258097619023237;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.502075583688913;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.49712481140331616;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 610;                        // OPTIMIZE [400, 4000] LOG
