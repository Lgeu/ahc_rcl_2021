...
constexpr double K_START = 0.0866043515995405;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05295706241221257;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8490285976503845;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 823;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.343293366907856;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5362528877044906;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 695;                        // OPTIMIZE [400, 4000] LOG
