...
constexpr double K_START = 0.0701453360150289;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05335391510664677;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8232740706036161;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.3001804277740505;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5296389368211615;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 624;                        // OPTIMIZE [400, 4000] LOG
