...
constexpr double K_START = 0.07547880407545056;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051471883500071966;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7942187811138289;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.3519325591289104;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.059282271947685594;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 598;                        // OPTIMIZE [400, 4000] LOG
