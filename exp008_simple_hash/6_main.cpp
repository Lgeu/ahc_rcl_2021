...
constexpr double K_START = 0.08485136855935058;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.050933821226294695;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7849920475826335;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.638222393422008;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.49076555407512323;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 600;                        // OPTIMIZE [400, 4000] LOG
