...
constexpr double K_START = 0.07438295821160366;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051066517132148506;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8256497242632376;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.3490366937957594;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.534740598630961;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 595;                        // OPTIMIZE [400, 4000] LOG
