...
constexpr double K_START = 0.07256592063878443;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.09937900197713437;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.834453554567503;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.620378797744823;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5132670492640057;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 542;                        // OPTIMIZE [400, 4000] LOG
