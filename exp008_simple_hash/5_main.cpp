...
constexpr double K_START = 0.08807608373516079;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05124825683634371;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.7982564635101436;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.5194063795195922;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5386747807621103;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 605;                        // OPTIMIZE [400, 4000] LOG
