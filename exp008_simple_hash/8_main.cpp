...
#endif
constexpr int hash_table_size = 10;         // OPTIMIZE [9, 18]


// K: 大きいほど未来の価値が小さくなる log2/100 = 0.007 くらいのとき野菜のインフレと釣り合う？
constexpr double K_START = 0.06438676153830912;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05229333878352686;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.8321505016103745;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.3839680550708238;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.5053230632947796;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 616;                        // OPTIMIZE [400, 4000] LOG
