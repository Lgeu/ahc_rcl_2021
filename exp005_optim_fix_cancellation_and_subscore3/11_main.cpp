...
constexpr double K_START = 0.05730525018766302;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.0499264570738415;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.3092323454184604;      // OPTIMIZE [0.001, 0.999]
