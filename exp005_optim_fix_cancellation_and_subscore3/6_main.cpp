...
constexpr double K_START = 0.057598703701662965;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04977348504648148;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.2675564067660544;      // OPTIMIZE [0.001, 0.999]
