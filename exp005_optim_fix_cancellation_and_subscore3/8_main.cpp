...
constexpr double K_START = 0.05774875435839423;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04986228157295879;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.3107079768948874;      // OPTIMIZE [0.001, 0.999]
