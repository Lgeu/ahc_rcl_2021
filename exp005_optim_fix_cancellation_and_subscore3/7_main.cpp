...
constexpr double K_START = 0.0574324494131054;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04989115651855045;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.2660480273639523;      // OPTIMIZE [0.001, 0.999]
