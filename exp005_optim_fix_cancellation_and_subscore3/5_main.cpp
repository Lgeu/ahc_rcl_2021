...
constexpr double K_START = 0.054908406877579245;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.049782874596229536;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.26548281361804504;      // OPTIMIZE [0.001, 0.999]
