...
constexpr double K_START = 0.05873369673952814;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04613606068598384;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.31913512274010525;      // OPTIMIZE [0.001, 0.999]
