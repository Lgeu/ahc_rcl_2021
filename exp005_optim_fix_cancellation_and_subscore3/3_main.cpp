...
constexpr double K_START = 0.05533771439222664;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04745001265679541;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.34049564228321455;      // OPTIMIZE [0.001, 0.999]
