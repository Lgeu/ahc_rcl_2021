...
constexpr double K_START = 0.05505399979649037;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04359377157113343;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.3464946964985501;      // OPTIMIZE [0.001, 0.999]
