...
constexpr double K_START = 0.059003801580066455;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04598430820211078;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.31454854155509204;      // OPTIMIZE [0.001, 0.999]
