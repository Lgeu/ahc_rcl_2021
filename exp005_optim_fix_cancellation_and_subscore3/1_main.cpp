...
constexpr double K_START = 0.05621240347788039;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.047244344855890075;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.33321028797983254;      // OPTIMIZE [0.001, 0.999]
