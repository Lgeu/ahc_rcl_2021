...
constexpr double K_START = 0.05637744276014564;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.043988285645753855;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.3431103162050017;      // OPTIMIZE [0.001, 0.999]
