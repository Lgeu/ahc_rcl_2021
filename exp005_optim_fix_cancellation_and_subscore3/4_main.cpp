...
constexpr double K_START = 0.0553828080172772;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.0473380159535797;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.26529194084161656;      // OPTIMIZE [0.001, 0.999]
