...
constexpr double K_START = 0.058015146172274525;  // OPTIMIZE [0.02, 0.06] LOG
constexpr double K_END = 0.04513737723056743;   // OPTIMIZE [0.01, 0.05] LOG
constexpr double K_H = 0.07967535524365929;      // OPTIMIZE [0.001, 0.999]
