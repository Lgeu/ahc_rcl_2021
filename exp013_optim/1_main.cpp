...
constexpr double K_START = 0.058536487631732324;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.058976985980956985;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.42096106196303945;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 833;  // OPTIMIZE [810, 850]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.0878286604095864;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.830139625602805;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1505;                        // OPTIMIZE [400, 4000] LOG
