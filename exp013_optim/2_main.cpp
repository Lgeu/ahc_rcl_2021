...
constexpr double K_START = 0.08763171695842112;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.05953603544110586;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.3325347567785209;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.30790109650491837;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6828918427894415;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1510;                        // OPTIMIZE [400, 4000] LOG
