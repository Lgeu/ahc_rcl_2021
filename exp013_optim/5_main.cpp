...
constexpr double K_START = 0.07885557602789868;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.06435717858594894;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.32813683612920835;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 829;  // OPTIMIZE [810, 850]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 2.567391615532213;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6520297130296757;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 472;                        // OPTIMIZE [400, 4000] LOG
