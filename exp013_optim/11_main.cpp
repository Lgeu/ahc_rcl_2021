...
constexpr double K_START = 0.08129610476052199;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.06199115420422385;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.36783852310639176;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 836;  // OPTIMIZE [810, 850]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8827484303838803;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.7159942755491483;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1569;                        // OPTIMIZE [400, 4000] LOG
