...
constexpr double K_START = 0.06643464752028118;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.06194046978909504;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.3972593322994199;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.904342649996905;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.7841708817056622;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1665;                        // OPTIMIZE [400, 4000] LOG
