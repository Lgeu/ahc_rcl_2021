...
constexpr double K_START = 0.07128063657930031;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.06502068605180893;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.32587478664339664;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 832;  // OPTIMIZE [810, 850]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.9963010372551169;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.07749964399618092;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1514;                        // OPTIMIZE [400, 4000] LOG
