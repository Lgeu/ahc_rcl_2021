...
constexpr double K_START = 0.0784177314050405;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.06448269381439803;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.559948243842833;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.9655841034324386;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.7218155585660575;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1668;                        // OPTIMIZE [400, 4000] LOG
