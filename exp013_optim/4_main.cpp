...
constexpr double K_START = 0.07887148674391062;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.049911881174019804;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4263989792164725;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.25251698005614104;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6511707362250446;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 761;                        // OPTIMIZE [400, 4000] LOG
