...
constexpr double K_START = 0.05856471523573173;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.05952916208705223;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4225964507240804;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.8081712226271263;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.6444539736580737;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1508;                        // OPTIMIZE [400, 4000] LOG
