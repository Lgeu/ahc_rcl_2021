...
constexpr double K_START = 0.07863321149246306;  // OPTIMIZE [0.04, 0.1] LOG
constexpr double K_END = 0.0644974366650905;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.9579178173492636;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 828;  // OPTIMIZE [810, 850]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 3.820014951371386;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.7806834951794724;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1369;                        // OPTIMIZE [400, 4000] LOG
