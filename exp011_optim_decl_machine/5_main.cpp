...
constexpr double K_START = 0.10085653038542379;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051904979314141016;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.629044234509279;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1915329527914977;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.9535325545270685;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1064;                        // OPTIMIZE [400, 4000] LOG
