...
constexpr double K_START = 0.10024353017699295;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05134424723567046;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5894177249367287;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1064943247336085;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.9549781488167441;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 990;                        // OPTIMIZE [400, 4000] LOG
