...
constexpr double K_START = 0.09874207413626239;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05147618803137946;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6220140515486077;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1328401308778007;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.952873808079487;  // OPTIMIZE [0.02, 0.98]
