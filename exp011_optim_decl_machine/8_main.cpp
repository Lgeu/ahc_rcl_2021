...
constexpr double K_START = 0.10556407072169387;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.04827769945244255;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5929178035720892;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.9479595441747927;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.954150402316354;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1017;                        // OPTIMIZE [400, 4000] LOG
