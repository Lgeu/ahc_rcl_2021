...
constexpr int hash_table_size = 14;         // OPTIMIZE [6, 18]


// K: 大きいほど未来の価値が小さくなる log2/100 = 0.007 くらいのとき野菜のインフレと釣り合う？
constexpr double K_START = 0.09778445620503241;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051757733247550224;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6278280584274223;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 842;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1661031134988915;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.9519441017552426;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1015;                        // OPTIMIZE [400, 4000] LOG
