...
constexpr int hash_table_size = 6;         // OPTIMIZE [6, 18]


// K: 大きいほど未来の価値が小さくなる log2/100 = 0.007 くらいのとき野菜のインフレと釣り合う？
constexpr double K_START = 0.10304661888763778;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05182502132632104;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.6269441884738481;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.2097632297597554;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.978830115250396;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1040;                        // OPTIMIZE [400, 4000] LOG
