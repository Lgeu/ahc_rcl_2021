...
constexpr double K_START = 0.10051343875440014;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05170473217542363;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5866127794406023;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1623490525882747;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.955769638158192;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1046;                        // OPTIMIZE [400, 4000] LOG
