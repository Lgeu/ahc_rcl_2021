...
constexpr double K_START = 0.10613306411251006;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05084651157201583;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5907538785957219;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.1168820668776718;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.9774930714571352;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1193;                        // OPTIMIZE [400, 4000] LOG
