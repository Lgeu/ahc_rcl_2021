...
constexpr double K_START = 0.10592837419024666;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.051296480088361615;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5849816402242622;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 841;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 1.192252845385241;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.9591661203385684;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1045;                        // OPTIMIZE [400, 4000] LOG
