...
constexpr double K_START = 0.07242924249148576;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.053737164701110444;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.5571912531392046;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.7250741352736529;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8632331955922001;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 545;                        // OPTIMIZE [400, 4000] LOG
