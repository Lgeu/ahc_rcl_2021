...
constexpr double K_START = 0.0752956644438197;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05389934645529834;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4817150487189273;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8763888110844792;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.811787079455555;  // OPTIMIZE [0.02, 0.98]
