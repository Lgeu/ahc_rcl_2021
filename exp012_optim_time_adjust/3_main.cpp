...
constexpr double K_START = 0.07206030160359841;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05478939765445003;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4795217531703639;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 831;  // OPTIMIZE [790, 870]

// 0 で通常
constexpr int SUBSCORE3_TIGHT_TURN = 0;     // OPTIMIZEd

constexpr int ROUGH_HASH = 0b00110011;      // OPTIMIZE {0, 0b00000001, 0b00010001, 0b00010011, 0b00110011}

// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.8640256485124411;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8666531948987414;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 569;                        // OPTIMIZE [400, 4000] LOG
