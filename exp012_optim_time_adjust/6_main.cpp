...
constexpr double K_START = 0.0753943475400837;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.054355014493754183;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4851822656037095;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 830;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.6875020397018908;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8119009207920037;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 1390;                        // OPTIMIZE [400, 4000] LOG
