...
constexpr double K_START = 0.07505759545333436;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05413123517869735;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4841272484396607;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.6987766124002021;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8314780122926996;  // OPTIMIZE [0.02, 0.98]
