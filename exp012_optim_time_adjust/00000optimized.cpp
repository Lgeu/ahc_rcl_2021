...
constexpr double K_START = 0.0699851356528291;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.058847686300459626;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4853321530941347;      // OPTIMIZE [0.001, 0.999]

constexpr short PURCHASE_TURN_LIMIT = 837;  // OPTIMIZE [790, 870]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.758270644991112;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8717724655547232;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 628;                        // OPTIMIZE [400, 4000] LOG
