...
constexpr double K_START = 0.06666940986852503;  // OPTIMIZE [0.04, 0.2] LOG
constexpr double K_END = 0.05253290645627345;   // OPTIMIZE [0.03, 0.1] LOG
constexpr double K_H = 0.4168856994110128;      // OPTIMIZE [0.001, 0.999]
...
// ビーム
constexpr double TARGET_BEAM_WIDTH_INCREASE_RATE = 0.5998577690831689;      // OPTIMIZE [0.25, 4.0] LOG
constexpr double TARGET_BEAM_WIDTH_HALF_PROGRES_RATE = 0.8232949151023742;  // OPTIMIZE [0.02, 0.98]
constexpr auto MAX_BEAM_WIDTH = 495;                        // OPTIMIZE [400, 4000] LOG
